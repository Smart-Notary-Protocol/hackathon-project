...
const NewClient = () => {
  ...
  return (
    <DatePickerWrapper>
      ...
      {
        transactionErrorAlert && <AlertComponent type="Address of client owner is already used for another Smart Client. use another one." severity="error" />}
      {
        transactionAlert && <AlertComponent type="Wait for the transaction till the Smart Client is created" severity="info" />
      }
    </DatePickerWrapper>
  )
}
